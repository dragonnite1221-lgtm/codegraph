/**
 * CLAUDE.md marked-section replacement tests for the installer config writer.
 * Split out of installer.test.ts to stay within the file-size gate.
 */
...
import { writeClaudeMd } from '../src/installer/config-writer';
