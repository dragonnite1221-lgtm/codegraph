/**
 * Pin the unsupported-Node block banner content. The banner replaced a soft
...
describe('buildUnsupportedNodeBlockBanner', () => {
  it('embeds the reported Node version in the header', () => {
    expect(buildUnsupportedNodeBlockBanner('24.16.0')).toContain(
      'Unsupported Node.js version: 24.16.0'
    );
  });

  it('names the V8 turboshaft WASM root cause and the OOM symptom', () => {
    const banner = buildUnsupportedNodeBlockBanner('24.16.0');
